...
const resources = {
  en: {
    translation: {
      ...
      deleteAllChatsMessage: "This will delete all the chats in history and restart the app.",
      cancel: "Cancel",
      delete: "Delete",
  ...
  es: {
    translation: {
      ...
      adPrefDesc: " Tomar control de tus anuncios: personalizar tu experiencia y revisar las políticas de Google",
  ...
  fr: {
    translation: {
      ...
      korean: "Coréen",
      thai: "Thaïlandais",
      adPrefDesc: "Prise de contrôle de vos annonces : personnaliser votre experience et consulter les politiques de Google",
  ...
  de: {
    translation: {
      ...
      adPrefDesc: " Kontrolle Ihrer Anzeigen: Persönnliche Erfahrung und Google-Politiken anzeigen",
  ...
  zh: {
    translation: {
      ...
      watchedAds: "观看的广告: ",
      adPrefDesc: " 控制你的广告：个性化你的体验和查看Google政策",
  ...
  jp: {
    translation: {
      ...
      korean: "韓国語",
      thai: "タイ語", 
      adPrefDesc: "広告を制御する：あなたの体験を個性化し、Google政策を確認する",
  ...
  kr:{
    translation: {
      ...
      adPref: " 광고 채팅 설정",
      adPrefDesc: " 채팅을 고각화하고 Google 총정을 고각화하면",
  ...
  th:{
    translation: {
      ...
      adPrefDesc: "ป้องกันโฆษณาและตรวจสอบนโยบาย Google",
